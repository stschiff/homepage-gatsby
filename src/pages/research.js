...
export default ({data}) => (
    <Layout pageTitle="Research" activeNav="/research">
        <section>
            ...
            <Img alt="A photograph of the statue 'The Dying Gaul', a logo of the ERC project and the logo of the ERC" fluid={data.header_img_erc.childImageSharp.fluid} width="100%" />
            <p>
        ...
        <section>
            ...
            <Img alt="Programming Code on dark background, two schematics depicting coalescence trees along sequences" fluid={data.header_img1.childImageSharp.fluid} width="100%"/>
            <p>
        ...
        <section>
            ...
            <Img alt="A human skeleton in archaeological context, a map of England and a schematic population model" fluid={data.header_img2.childImageSharp.fluid} width="100%"/>
            <p>
        ...
        <section>
            ...
            <Img alt="A chart showing genetic linkage on natural selection, a chart showing allele frequency spectra" fluid={data.header_img3.childImageSharp.fluid} width="100%"/>
            <p>
